...
export default async function Home() {
  const languages = await getUsersTopLanguages("hacksore");

  return (
    <main className="flex min-h-screen text-white bg-black p-24">
      This is gitlang
      <pre>data: {JSON.stringify(languages, null, 2)}</pre>
    </main>
  );
}
